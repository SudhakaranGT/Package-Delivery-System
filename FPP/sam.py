...
def signup2(ph,pas,con):
    ...
    if (not flag and len(ph)==10 and pas==con):
        ...
        Label(q,text="Address",bg="#57a1f8",fg="black",width=10,pady=5,padx =30,font =("Microsoft YaHei UI Light",15,"bold")).place(x=100,y=200)
        ad_s= Entry(q,width = 40,bg ="white",fg ="black",font=("Microsoft YaHei UI Light",18))
        ad_s.place(x=290,y=202)

        Label(q,text="City/Town",bg="#57a1f8",fg="black",width=10,pady=5,padx =30,font =("Microsoft YaHei UI Light",15,"bold")).place(x=100,y=250)
        loc_s= Entry(q,width = 40,bg ="white",fg ="black",font=("Microsoft YaHei UI Light",18))
        loc_s.place(x=290,y=252)
        
        Button(q,width=15,pady = 20,text="Create Account",bg ="#57a1f8",fg = "white",border=0,command =lambda: signup3(ph,pas,name_s.get(),ad_s.get(),loc_s.get())).place(x=350,y=385)
...
def Update():
    ...
    Button(q,width=15,pady = 20,text="Update",bg ="#57a1f8",fg = "white",border=0,command =lambda: signup3(currentuser,pas,name_s.get(),ad_s.get(),loc_s.get())).place(x=500,y=385)
    Button(q,width=15,pady = 20,text="Previous",bg ="#57a1f8",fg = "white",border=0,command =navigatebefore).place(x=350,y=385)
    q.mainloop()


def signup3(ph,pas,name,ad,loc):
    f=open("accounts.json","r")
    try:
        l=json.load(f)
    except:
        l={}
    g=open("temp.json","w")
    l[ph]={"password":pas,"name":name,"address":ad,"location":loc}
...
def AdminMenu():
        ...
        image =PhotoImage(file="ame.png")
        Label(next,image=image).pack()

        #Frame2 = Frame(next,height=425,width =910).place(x=5,y=60)

        #Label(next,text ="Menu",width = 30,pady = 5,bg ="black",fg ="#57a1f8",font =("Microsoft YaHei UI Light",15,"bold")).place(x=40,y=80)

        button1 = Button(next,text="Parcel Information",width=30,pady = 5,bg ="#2C3333",fg ="white",border=3,command=track).place(x=105,y=200)
        button2 = Button(next,text="List of deliveries - date wise",width=30,pady = 5,bg ="#2C3333",fg ="white",border=3,command=date_wise).place(x=105,y=265)
        button3 = Button(next,text="List of deliveries - Location wise",width=30,pady = 5,bg ="#2C3333",fg ="white",border=3,command =location_wise).place(x=105,y=330)
        logout = Button(next,text="logout",width=30,pady = 5,bg ="#2C3333",fg ="white",border=3,command=navigatebefore).place(x=105,y=395)
...
def track():
    ...
    imagek = PhotoImage(file ="rty.png")
    Label(next3,image = imagek).pack()
    ...
    head=Label(next3,text="Track No",fg = "white",bg="#0FBCF9",padx = 10,pady=2,font =("Microsoft YaHei UI Light",15,"bold"))
    head.place(x=25,y=175)

    num=Entry(next3,width = 20,bg ="white",fg ="black",font=("Microsoft YaHei UI Light",18))
    num.place(x=145,y=175)
    
    
    Button(next3,width=39,pady = 5,border = 5,text="Track",bg ="#0FBCF9",fg = "white",cursor ="hand2",command =lambda:tab3(num.get())).place(x=75,y=220)
    Button(next3,width=15,pady = 5,border = 5,text="Previous",bg ="#0FBCF9",fg = "white",cursor ="hand2",command =navigatebefore).place(x=40,y=350)
    next3.mainloop()
...
def date_wise():
    ...
    image = PhotoImage(file ="date1.png")
    Label(next5,image = image).pack()
...
#Frame2 = Frame(next5,height=425,width =910,bg="white").place(x=5,y=60)
    ...
    head=Label(next5,text="Date",fg = "white",bg="#0FBCF9",padx = 10,pady=2,font =("Microsoft YaHei UI Light",15,"bold"))
    head.place(x=25,y=175)

    date=Entry(next5,width = 20,bg ="white",fg ="black",font=("Microsoft YaHei UI Light",18))
    date.place(x=100,y=175)
    
    Button(next5,width=25,pady = 5,border = 5,text="Track",bg ="#0FBCF9",fg = "white",cursor ="hand2",command =lambda:tab4(date.get())).place(x=75,y=220)
    Button(next5,width=15,pady = 5,border = 5,text="Previous",bg ="#0FBCF9",fg = "white",cursor ="hand2",command =navigatebefore).place(x=50,y=350)
    next5.mainloop()
...
def tab4(dt):
    ...
    try:
        ...
        navigatebefore()
        messagebox.showerror("No records","No records present in the given date")
        return
...
pages=stack()
root = Tk()
root.title("Tyson Courier system")
...
image0 = PhotoImage(file="sk2.png")
...
frame = Frame(root,width =350,height=350,bg="#0FBCF9")
frame.place(x=500,y=135)

head=Label(frame,text="Login",fg = "black",bg="#0FBCF9",font =("Microsoft YaHei UI Light",23,"bold"))
...
user = Entry(frame,width=25,fg= 'white',border=0,bg="#0FBCF9",font =("Microsoft YaHei UI Light",11))
...
password = Entry(frame,width=25,fg= 'white',border=0,bg="#0FBCF9",font =("Microsoft YaHei UI Light",11))
...
Button(frame,width=39,pady = 7,text="Login",bg ="#2C3333",fg = "white",border=0,command = lambda:signin()).place(x=35,y=204)
label = Label(frame,text = "Don't have an Account..? ",fg="white",bg="#0FBCF9",font =("Microsoft YaHei UI Light",9))
label.place(x=75,y=270)

sign_up = Button(frame,width = 6,text ="Sign up",border=0,bg="#0FBCF9",cursor="hand2",fg ="red",command=signup)
